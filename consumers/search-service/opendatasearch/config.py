...
UMBRAL_SIMILITUD = 0.3 # Umbral de similitud para keywords
UMBRAL_SIMILITUD_GENERATIVO = 0.3 # Umbral de similitud para intents (como generan varias queries, podría ser interesante subir el umbral)
