...
import static org.eclipse.edc.heleade.common.NegotiationCommon.runNegotiation;
...
@EndToEndTest
@Testcontainers
public class Transfer03providerPullTest {

    private static final String START_TRANSFER_PULL_FILE_PATH = "system-tests/src/test/resources/transfer/start-transfer-pull.json";
    ...
    @Test
    void runProviderPullSteps() {
        var contractAgreementId = runNegotiation();
        var port = httpRequestLoggerContainer.getPort();
        var requestBody = getFileContentFromRelativePath(START_TRANSFER_PULL_FILE_PATH)
        ...
        assertThat(data).contains("Leanne Graham");
    }
}
