...
package org.eclipse.edc.heleade.transfer;
...
import static org.eclipse.edc.heleade.common.NegotiationCommon.runNegotiationService;
...
import static org.eclipse.edc.heleade.util.TransferUtil.pullTransferGetData;
import static org.eclipse.edc.heleade.util.TransferUtil.startTransfer;

@EndToEndTest
@Testcontainers
public class Transfer04providerServicePullTest {

    private static final String START_TRANSFER_PULL_SERVICE_FILE_PATH = "system-tests/src/test/resources/transfer/start-transfer-pull-service.json";
    ...
    @Test
    void runProviderServicePullSteps() {
        int port = httpRequestLoggerContainer.getPort();
        var contractAgreementId = runNegotiationService(port);
        var requestBody = getFileContentFromRelativePath(START_TRANSFER_PULL_SERVICE_FILE_PATH)
        ...
        String data = pullTransferGetData(transferProcessId);
