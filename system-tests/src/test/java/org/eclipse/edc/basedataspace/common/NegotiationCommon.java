...
public class NegotiationCommon {
    ...
    private static final String CREATE_ASSET_FILE_PATH = "system-tests/src/test/resources/create-asset.json";
    private static final String V3_ASSETS_PATH = "/v3/assets";
    private static final String CREATE_POLICY_FILE_PATH = "system-tests/src/test/resources/create-policy.json";
    private static final String V2_POLICY_DEFINITIONS_PATH = "/v3/policydefinitions";
    private static final String CREATE_CONTRACT_DEFINITION_FILE_PATH = "system-tests/src/test/resources/create-contract-definition.json";
