...
/**
 * Extension for initializing and managing Verifiable Credentials in the system.
 * Implements functionality to load credentials from a specified directory during startup.
 */
